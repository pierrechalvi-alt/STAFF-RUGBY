...
// Nouvelle ligne : date de naissance
...
// Ajout dans le header dans le bon ordre
phMain.appendChild(phName);
phMain.appendChild(phBirth);   // <-- la nouvelle ligne s'insère ici
